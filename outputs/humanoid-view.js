...
open.addEventListener('click',show);exit.addEventListener('click',hide);$('main-humanoid-replay')?.addEventListener('click',()=>inline.replay());view.addEventListener('keydown',e=>{if(e.key==='Escape'){e.preventDefault();hide();}});
